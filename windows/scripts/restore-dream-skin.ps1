...
try {
  ...
  try {
    ...
    if ($Uninstall) {
      ...
      @(
        (Join-Path $desktop 'Codex Kanna Blue Skin.lnk'),
        (Join-Path $desktop 'Codex Kanna Blue Skin - Restore.lnk'),
        (Join-Path $desktop 'Codex Kanna Blue Skin - Tray.lnk'),
        (Join-Path $startMenu 'Codex Kanna Blue Skin.lnk'),
        (Join-Path $startMenu 'Codex Kanna Blue Skin - Tray.lnk'),
