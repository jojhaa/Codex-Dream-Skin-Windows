...
const featuredPath = path.join(windowsRoot, "assets", "dream-reference.png");
...
const jpeg = await fs.readFile(path.join(windowsRoot, "presets", "preset-gothic-void-crusade", "background.jpg"));
const malformedJpeg = Buffer.from(jpeg.subarray(0, 64));
malformedJpeg[0] = 0;
